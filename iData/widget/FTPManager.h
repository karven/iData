...
#define kFMServer [FMServer shareFMServerInstance]
...
//@property (strong) NSMutableArray *destinationArray;
...
#define kFTPManager [FTPManager shareInstance]
#pragma mark -
...
@property(strong) NSMutableArray *folderArray;                  //路径地址(一级一级目录，分层)
@property(strong) NSMutableArray *selectFileArray;              //被选中的路径(全路径)
